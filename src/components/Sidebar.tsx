...
export function Sidebar() {
  ...
  return (
    <nav className="w-64 bg-[var(--sidebar)] p-6 flex flex-col gap-2">
      <div className="mb-8">
        <h1 className="text-xl font-bold text-white">Metaapps</h1>
        <p className="text-xs text-[var(--sidebar-foreground)] opacity-70">Unified Ads Manager</p>
      </div>
      {NAV_ITEMS.map((item) => (
